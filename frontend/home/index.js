...
const ListCamerasDisplay = async() => {
    ...
    document.querySelector(".container-produits").innerHTML += listCameras.map((camera) =>
            `<div class= "card col-12 col-md-4">
                        <div class="card-body">
                            ...
                            <button><a href= "../Produits.html?id=${camera._id}"data-ref="${camera.id}"> En savoir plus </a></button>
